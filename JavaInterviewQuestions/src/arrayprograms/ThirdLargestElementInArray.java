...
public class ThirdLargestElementInArray {
	...
	public static void main(String[] args) {
		...
		System.out.println(a[total-3]);//used length
...
//		System.out.println(b[total1-3]);//used length
//		
...
//		
//		}
//		//System.out.println(a[4]);//third largest number using index
//		System.out.println("third largest number is is:"+a[total-3]);
